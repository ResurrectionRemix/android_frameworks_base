 ...
 */
public class SamsungAccentClockController implements ClockPlugin {
     ...
     */
    public SamsungAccentClockController(Resources res, LayoutInflater inflater,
   ...
   public void refreshclocksize() {
    ...
    public String getName() {
        return "samsung_accent";
    }

    @Override
    public String getTitle() {
        return mResources.getString(R.string.clock_title_samsung_accent_2);
    }
